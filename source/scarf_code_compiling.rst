...
If you are confident in what you are doing and have a specific requirement to compile for only one architecture we would advise contacting the `Helpdesk <contact_us>`_ for further details, as this will enable us to give you the best advice for your situation.
